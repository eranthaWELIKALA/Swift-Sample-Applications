...
class RotatingCirclesView: UIView {
    ...
    let positions: [CGRect] = [
        CGRect(x: 30, y: 20, width: 60, height: 60), // Left corner
        CGRect(x: 60, y: 15, width: 70, height: 70), // Center top layer
        CGRect(x: 110, y: 20, width: 60, height: 60),// Center bottom layer
        CGRect(x: 60, y: 25, width: 50, height: 50)  // Right corner
    ]
